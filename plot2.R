...
png(filename = "plot2.png", bg = "transparent")        # Create the .PNG file with transparent background
plot(HPC2D$DateTime,HPC2D$Global_active_power, type="l",ylab = "Global Active Power (in kiloWatts)", xlab = " ")      #Plot 2  - Global Active Power over DateTime
